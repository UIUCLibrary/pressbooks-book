...
<h1><a href="https://pb-sandbox.library.illinois.edu">
	<img align="left" src="<?php echo get_template_directory_uri(); ?>/assets/images/iopn_navy.png" alt="IOPN Network" width="186" height="100" ></img>
	<img align="text-bottom" src="<?php echo get_template_directory_uri(); ?>/assets/images/ui_library.png" alt="university branding" width="286" height="200" ></img></a></h1>
</header>
